...
#
#     from btspusher import metadata
#
# However, when we do this, we also import `btspusher/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'btspusher= btspusher.main:entry_point'
        ],
    }
)
